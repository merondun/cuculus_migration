...
#grab 3 random samples from each population
grep -w ${P1} ~/merondun/cuculus_migration/Samples_Demography_N10_CCW-CCE-CO_20241220.pop | awk '{print $1}' | shuf | head -n 3 > crosscoal/${P1}_${P2}_${IT}.inds
grep -w ${P2} ~/merondun/cuculus_migration/Samples_Demography_N10_CCW-CCE-CO_20241220.pop | awk '{print $1}' | shuf | head -n 3 >> crosscoal/${P1}_${P2}_${IT}.inds
...
~/modules/msmc2_Linux -t 15 -p 1*2+16*1+1*2 -I 0,1,2,3,4,5 -o crosscoal/output/${P1}_${P2}_${IT}_msmc_FIRST $(ls crosscoal/input/${P1}_${P2}_${IT}_*)
~/modules/msmc2_Linux -t 15 -p 1*2+16*1+1*2 -I 6,7,8,9,10,11 -o crosscoal/output/${P1}_${P2}_${IT}_msmc_SECOND $(ls crosscoal/input/${P1}_${P2}_${IT}_*)
~/modules/msmc2_Linux -t 15 -p 1*2+16*1+1*2 -I 0-6,0-7,0-8,0-9,0-10,0-11,1-6,1-7,1-8,1-9,1-10,1-11,2-6,2-7,2-8,2-9,2-10,2-11,3-6,3-7,3-8,3-9,3-10,3-11,4-6,4-7,4-8,4-9,4-10,4-11,5-6,5-7,5-8,5-9,5-10,5-11 -s -o crosscoal/output/${P1}_${P2}_${IT}_msmc_ALLHAPS $(ls crosscoal/input/${P1}_${P2}_${IT}_*)
